...
export default function FengShuiReport({ reading }: FengShuiReportProps) {
  return (
    <div className="space-y-6">
      {/* Overview */}
      <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
        <CardContent className="p-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-teal-900">Feng Shui Overview</h3>
            </div>
        ...
        <CardContent className="p-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-teal-900">Kua Number Analysis</h3>
            </div>
      ...
      <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
        <CardContent className="p-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <Sparkles className="w-6 h-6 text-teal-700" />
              <h3 className="text-xl font-bold text-teal-900">Element Analysis</h3>
            </div>
      ...
      {Object.keys(reading.baguaRecommendations).length > 0 && (
        <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
          <CardContent className="p-6">
            ...
            >
              <h3 className="text-xl font-bold text-teal-900 mb-4">Bagua Area Recommendations</h3>
              <div className="space-y-4">
                {Object.entries(reading.baguaRecommendations).map(([area, recommendations]) => (
                  <div key={area} className="border-b border-amber-200 pb-3 last:border-0 last:pb-0">
                    <h4 className="font-semibold text-teal-900 mb-2">{area}</h4>
      ...
      {reading.wealthTips.length > 0 && (
        <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
          <CardContent className="p-6">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <Coins className="w-6 h-6 text-teal-700" />
                <h3 className="text-xl font-bold text-teal-900">Wealth & abundance pointers</h3>
              </div>
          ...
          <CardContent className="p-6">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-teal-900">Home checklist</h3>
              </div>
              <ul className="space-y-2">
      ...
      <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
        <CardContent className="p-6">
          ...
          >
            <h3 className="text-xl font-bold text-teal-900 mb-4">General Recommendations</h3>
            <ul className="space-y-2">
          ...
          <CardContent className="p-6">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-teal-900">Timing Advice</h3>
              </div>
              <ul className="space-y-2">
                {reading.timingAdvice.map((advice, i) => (
                  <li key={i} className="flex items-start gap-2 text-slate-700">
                    <Clock className="w-4 h-4 text-teal-700 mt-0.5 flex-shrink-0" />
                    <span>{advice}</span>
                  </li>
                ))}
              </ul>
