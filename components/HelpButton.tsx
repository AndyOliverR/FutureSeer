  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="bg-slate-900 border-amber-400/30 max-w-md">
          <DialogHeader>
          ...
          <div className="space-y-4 mt-4">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-4 rounded-lg bg-slate-800/50 border border-amber-400/30 hover:bg-slate-800 hover:border-amber-400/50 transition-colors text-left"
            >
