...
export function MysticalFeedback({ isOpen, onClose }: MysticalFeedbackProps) {
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between p-6 border-b border-amber-500/30">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-serif text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-blue-400 to-amber-600">
