...
export function ToolSymbol({
  ...
  const toolSymbolMap: Record<string, string> = {
    ...
    'synastry': 'libra',
    'horary': 'mercury',
    'horary-astrology': 'mercury',
    'kabbalistic-numerology': 'keter',
    'medical-astrology': 'mars',
    'kp-astrology': 'jupiter',
    'bazi': 'leo',
    'angel-numbers': 'seven',
    'dream-symbols': 'moon',
    'name-analysis': 'mercury',
    'geomancy': 'taurus',
    '13-signs-zodiac': 'scorpio',
    'thirteen-signs-zodiac': 'scorpio',
    'hellenistic-astrology': 'aries',
    'esoteric-astrology': 'sun',
    'kabbalistic-astrology': 'keter',
    'hermetic-astrology': 'mercury',
    'astrocartography': 'jupiter',
    'human-design': 'sun',
    'akashic-records': 'high_priestess',
    'ogham': 'taurus',
    'sortilege': 'fool',
    'scrying': 'moon',
    'bibliomancy': 'high_priestess',
    'energy-healing': 'sun',
    'feng-shui': 'capricorn',
    'financial-astrology': 'one',
    'mundane-astrology': 'jupiter',
    'psychological-astrology': 'moon',
    'shamanic-astrology': 'moon',
    'ziwei-dou-shu': 'leo',
    'navaratna-planetary-stones': 'venus',
    'daily-decisions': 'mercury',
    'trichakra-method': 'sun',
  }

  const symbolId = toolSymbolMap[toolName] || 'sun'
