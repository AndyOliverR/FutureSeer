...
export function ActiveRemedyCard({ remedy, type, status }: ActiveRemedyCardProps) {
  ...
  return (
    <section className={`w-full rounded-2xl backdrop-blur-sm bg-slate-900/30 border border-slate-700/50 shadow-lg p-6 flex flex-col items-center mb-2 relative card-glow ${status === "Pending" ? "animate-pulse" : ""}`}>
      <h3 className="text-xl font-serif text-transparent bg-clip-text bg-gradient-to-b from-amber-200 via-yellow-400 to-amber-600 mb-2">Active Remedy</h3>
