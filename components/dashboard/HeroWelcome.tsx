...
export function HeroWelcome({ userName, lunarPhase, dominantElement }: HeroWelcomeProps) {
  return (
    <section className="w-full rounded-2xl backdrop-blur-md bg-slate-900/30 border border-slate-700/50 shadow-lg py-10 px-6 flex flex-col items-center justify-center text-center mb-2 card-glow">
      <h2 className="text-3xl md:text-5xl font-serif font-semibold text-transparent bg-clip-text bg-gradient-to-b from-amber-200 via-yellow-400 to-amber-600 mb-2">
        Welcome back, <span className="italic">{userName}</span> ✨
      </h2>
      <div className="flex flex-col md:flex-row gap-2 md:gap-6 items-center justify-center text-lg font-serif text-amber-200 mb-2">
