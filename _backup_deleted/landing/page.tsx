...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 cosmic-starfield-hybrid"></div>
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-12 w-full max-w-2xl justify-center">
            <Dialog open={openJourney} onOpenChange={setOpenJourney}>
              <DialogTrigger asChild>
                <Button
                  variant="glass"
                  className="glass-button-enhanced w-full md:w-1/2 text-center font-serif text-lg rounded-2xl px-8 py-3"
                >
