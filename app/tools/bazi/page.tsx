    ...
    <div className="min-h-screen p-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl font-bold gold-glow mb-4">🏮 BaZi</h1>
          <p className="text-soft leading-relaxed text-lg mb-4">
            Four Pillars of Destiny - Ancient Chinese system of life path analysis
          </p>
          {/* Inspirational Quote */}
          <div className="glass-card rounded-2xl p-6 border border-red-500/20 max-w-2xl mx-auto">
            <p className="text-xl italic text-red-300 font-serif mb-2">
              "In the four pillars of your birth moment lies the complete map of your destiny, written in the language of heaven and earth."
            </p>
            <p className="text-soft/70 text-sm">— Master Zi Wei</p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="glass-card rounded-3xl p-6 border border-white/10">
              <h2 className="text-2xl gold-glow mb-6 text-center">Four Pillars</h2>
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <option value="luck">Luck & Fortune</option>
              ...
              <div className="mb-8 p-4 rounded-xl bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/20">
                ...
                <ul className="space-y-1 text-sm text-soft/80">
                  <li>• Four pillars analysis</li>
                  <li>• Heavenly stems & earthly branches</li>
                  <li>• Elemental balance</li>
                  <li>• Destiny timing</li>
                </ul>
              </div>
          ...
          >
            <div className="glass-card rounded-3xl p-6 border border-white/10">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["overview", "pillars", "elements", "luck", "timing", "advice"].map((tab) => (
                  <motion.button
                    key={tab}
              ...
              <AnimatePresence mode="wait">
                {isLoading ? (
                  ...
                  >
                    ...
                    <p className="text-soft text-lg">Calculating your Four Pillars of Destiny...</p>
                  </motion.div>
                ) : error ? (
                  <motion.div
                    key="error"
                  ...
                  >
                    ...
                    <h3 className="text-2xl gold-glow mb-4">Ready to Discover Your Four Pillars?</h3>
                    <p className="text-soft leading-relaxed">
                      Enter your birth details above to unlock the ancient Chinese 
                      system of destiny reading through the Four Pillars of BaZi.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
        ...
        >
          <h3 className="text-2xl gold-glow mb-6 text-center">✨ BaZi Features</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl mb-3">🏮</div>
              <h4 className="text-soft font-semibold mb-2">Four Pillars</h4>
              <p className="text-soft/70 text-sm">Year, month, day, hour</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">🌿</div>
              <h4 className="text-soft font-semibold mb-2">Elements</h4>
              <p className="text-soft/70 text-sm">Wood, fire, earth, metal, water</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">🎯</div>
              <h4 className="text-soft font-semibold mb-2">Destiny Reading</h4>
              <p className="text-soft/70 text-sm">Life path analysis</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">✨</div>
              <h4 className="text-soft font-semibold mb-2">Chinese Wisdom</h4>
              <p className="text-soft/70 text-sm">Ancient traditions</p>
            </div>
          </div>
        </motion.div>
      </div>
