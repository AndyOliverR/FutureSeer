...
// Professional Vedic Lagna Chart with enhanced visual quality
export function LagnaChartSVG({ planets }: { planets: Array<{ planet: string, sign: string, house: number }> }) {
  ...
  return (
    <svg viewBox="0 0 300 300" width={280} height={280} className="professional-vedic-chart">
      <defs>
        ...
        <filter id="vedic-shadow" x="-50%" y="-50%" width="200%" height="200%">
