  ...
  return (
    <div className="min-h-screen p-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="glass-card rounded-2xl p-6 border border-green-500/20 max-w-2xl mx-auto">
            <p className="text-xl italic text-green-300 font-serif mb-2">
              "When your home aligns with the cosmic energies, prosperity flows like a river and peace dwells in every corner."
            </p>
            <p className="text-soft/70 text-sm">— Vastu Shastra</p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="glass-card rounded-3xl p-6 border border-white/10">
              <h2 className="text-2xl gold-glow mb-6 text-center">Sacred Architecture</h2>
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <option value="relationships">Relationships & Harmony</option>
              ...
              <div className="mb-8 p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
                ...
                <ul className="space-y-1 text-sm text-soft/80">
                  ...
                  <li>• Cosmic energy flow</li>
                  <li>• Directional harmony</li>
          ...
          >
            <div className="glass-card rounded-3xl p-6 border border-white/10">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["overview", "directions", "elements", "remedies", "timing", "advice"].map((tab) => (
                  <motion.button
                    key={tab}
              ...
              <AnimatePresence mode="wait">
                {isLoading ? (
                  ...
                  >
                    ...
                    <p className="text-soft text-lg">Analyzing cosmic energy flow in your space...</p>
                  </motion.div>
                ) : error ? (
                  <motion.div
                    key="error"
                  ...
                  >
                    ...
                    <h3 className="text-2xl gold-glow mb-4">Ready for Sacred Architecture?</h3>
                    <p className="text-soft leading-relaxed">
                      Enter your property details above to discover how cosmic energies 
                      flow through your space and unlock the secrets of Vastu harmony.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
        ...
        >
          <h3 className="text-2xl gold-glow mb-6 text-center">✨ Vastu Features</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl mb-3">🧭</div>
              <h4 className="text-soft font-semibold mb-2">Directions</h4>
              <p className="text-soft/70 text-sm">Cosmic alignment</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">⚡</div>
              <h4 className="text-soft font-semibold mb-2">Energy Flow</h4>
              <p className="text-soft/70 text-sm">Prana circulation</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">🌿</div>
              <h4 className="text-soft font-semibold mb-2">Elements</h4>
              <p className="text-soft/70 text-sm">Natural balance</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">✨</div>
              <h4 className="text-soft font-semibold mb-2">Sacred Geometry</h4>
              <p className="text-soft/70 text-sm">Divine proportions</p>
            </div>
          </div>
        </motion.div>
      </div>
