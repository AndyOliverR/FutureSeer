    ...
    <div className="min-h-screen p-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {/* Inspirational Quote */}
          <div className="glass-card rounded-2xl p-6 border border-brown-500/20 max-w-2xl mx-auto">
            <p className="text-xl italic text-brown-300 font-serif mb-2">
              "The earth speaks in patterns, and those who listen to her sacred geometry find answers in the soil of wisdom."
            </p>
            <p className="text-soft/70 text-sm">— Medieval Geomantic Tradition</p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="glass-card rounded-3xl p-6 border border-white/10">
              <h2 className="text-2xl gold-glow mb-6 text-center">Earth Divination</h2>
              ...
              {/* Instructions */}
              <div className="mb-8 p-4 rounded-xl bg-gradient-to-r from-brown-500/10 to-amber-500/10 border border-brown-500/20">
              ...
              <div className="space-y-4">
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-brown-500 to-amber-600 text-white rounded-xl p-4 font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-xl transition-all duration-300"
                >
          ...
          >
            <div className="glass-card rounded-3xl p-6 border border-white/10">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {["overview", "figures", "houses", "interpretation", "timing", "advice"].map((tab) => (
                  <motion.button
                    key={tab}
                    ...
                    className={`px-4 py-2 rounded-xl font-medium transition-all duration-300 ${
                      activeTab === tab
                        ? "bg-gradient-to-r from-brown-500 to-amber-600 text-white"
              ...
              <AnimatePresence mode="wait">
                {isLoading ? (
                  ...
                  >
                    ...
                    <p className="text-soft text-lg">Consulting the earth's wisdom...</p>
                  </motion.div>
                ) : error ? (
                  <motion.div
                    key="error"
                  ...
                  >
                    ...
                    <p className="text-red-400 text-lg mb-2">Divination Error</p>
                  ...
                  >
                    ...
                    <h3 className="text-2xl gold-glow mb-4">Ready for Earth Divination?</h3>
        ...
        >
          <h3 className="text-2xl gold-glow mb-6 text-center">✨ Geomancy Features</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl mb-3">🔺</div>
              <h4 className="text-soft font-semibold mb-2">Sacred Geometry</h4>
              <p className="text-soft/70 text-sm">Ancient geometric patterns reveal hidden truths</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">🌍</div>
              <h4 className="text-soft font-semibold mb-2">Earth Wisdom</h4>
              <p className="text-soft/70 text-sm">Connect with elemental forces and natural cycles</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">⚡</div>
              <h4 className="text-soft font-semibold mb-2">Quick Answers</h4>
              <p className="text-soft/70 text-sm">Rapid divination for immediate guidance</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-3">🏰</div>
              <h4 className="text-soft font-semibold mb-2">Medieval Tradition</h4>
              <p className="text-soft/70 text-sm">Ancient European divination practice</p>
            </div>
          </div>
        </motion.div>
      </div>
