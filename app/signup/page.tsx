...
import { Loader2, Mail, Lock, Eye, EyeOff, ArrowLeft, Sparkles, User, Apple, Facebook } from "lucide-react"
...
export default function SignUpPage() {
  ...
  const signUpButtons = appleFirst
    ? [
        {
                ...
                <div className="flex flex-col items-center mb-2">
                  ...
                  <div className="flex flex-row gap-3 justify-center">
                    ...
                    <Button
                      size="icon"
                      variant="outline"
                      aria-label="Sign up with X.com"
                      onClick={() => alert('X.com (Twitter) sign-up not yet implemented.')}
