          ...
          <div className="w-full bg-surface-container-high rounded-[32px] p-6 sm:p-8 border border-outline-variant shadow-2xl overflow-hidden glass-effect">
            {!showSignupFlow && (
              <>
                ...
                <Button onClick={handleGoogleSignIn} disabled={isLoading || !confirmAge16} className="w-full h-14 bg-white text-slate-900 rounded-2xl font-bold flex items-center justify-center gap-3 shadow-lg active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            {showSignupFlow ? (
              ...
              <form onSubmit={handleBasicInfoSubmit} className="space-y-5">
                ...
                <Button type="submit" disabled={isLoading || !confirmAge16} className="w-full h-14 bg-amber-500 text-slate-900 rounded-2xl font-bold text-lg shadow-lg active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed">
